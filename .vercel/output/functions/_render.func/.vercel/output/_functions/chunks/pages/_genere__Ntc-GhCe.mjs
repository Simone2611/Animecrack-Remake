...
const $$genere = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$genere;
  const { JSDOM } = jsdom;
  let arr = [];
  let genere = Astro2.request.url;
  let generefix = genere.replaceAll(Astro2.url.origin + "/generi/", "");
  let generefix2 = generefix.replaceAll(/\d+/g, "");
  let nome = generefix2.replaceAll("?page=", "");
  await axios.get("https://www.animeworld.so/genre/" + generefix).then(({ data }) => {
...
}, "C:/Users/simon/Desktop/AnimeCrack/Animecrack-Remake/src/pages/generi/[genere].astro", void 0);

const $$file = "C:/Users/simon/Desktop/AnimeCrack/Animecrack-Remake/src/pages/generi/[genere].astro";
const $$url = "/generi/[genere]";

export { $$genere as default, $$file as file, $$url as url };
